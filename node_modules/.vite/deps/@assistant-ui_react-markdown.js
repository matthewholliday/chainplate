import {
  ...
  values,
  visit
} from "./chunk-GQADSK45.js";
import {
  internal_exports,
  useMessagePartText
} from "./chunk-N3MHNBSF.js";
import {
  useCallbackRef
} from "./chunk-N25QWNWN.js";
import "./chunk-UEHR66ST.js";
import "./chunk-OYIRJU3Y.js";
...
var memoizeMarkdownComponents = (components = {}) => {
  return Object.fromEntries(Object.entries(components ?? {}).map(([key, value]) => {
    ...
    const WithoutNode = ({ node, ...props }) => {
      return (0, import_jsx_runtime.jsx)(Component, { ...props });
    };
...
var PreContext = (0, import_react2.createContext)(null);
var useIsMarkdownCodeBlock = () => {
  return (0, import_react2.useContext)(PreContext) !== null;
};
var PreOverrideImpl = ({ children, ...rest }) => {
  return (0, import_jsx_runtime2.jsx)(PreContext.Provider, {
    value: rest,
    children
  });
};
var PreOverride = (0, import_react2.memo)(PreOverrideImpl, memoCompareNodes);

// node_modules/@assistant-ui/react-markdown/dist/overrides/defaultComponents.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var DefaultPre = ({ node, ...rest }) => (0, import_jsx_runtime3.jsx)("pre", { ...rest });
var DefaultCode = ({ node, ...rest }) => (0, import_jsx_runtime3.jsx)("code", { ...rest });
var DefaultCodeBlockContent = ({ node, components: { Pre, Code }, code: code2 }) => (0, import_jsx_runtime3.jsx)(Pre, { children: (0, import_jsx_runtime3.jsx)(Code, {
  node,
  children: code2
}) });
...
var DefaultCodeBlock = ({ node, components: { Pre, Code, SyntaxHighlighter, CodeHeader }, language, code: code2 }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [(0, import_jsx_runtime4.jsx)(CodeHeader, {
    node,
    language,
    code: code2
  }), (0, import_jsx_runtime4.jsx)(language ? SyntaxHighlighter : DefaultCodeBlockContent, {
    node,
    components,
...
var CodeBlockOverride = ({ node, components: { Pre, Code, SyntaxHighlighter: FallbackSyntaxHighlighter, CodeHeader: FallbackCodeHeader }, componentsByLanguage = {}, children, ...codeProps }) => {
  const getPreProps = withDefaultProps((0, import_react4.useContext)(PreContext));
  const WrappedPre = useCallbackRef((props) => (0, import_jsx_runtime5.jsx)(Pre, { ...getPreProps(props) }));
  const getCodeProps = withDefaultProps(codeProps);
  const WrappedCode = useCallbackRef((props) => (0, import_jsx_runtime5.jsx)(Code, { ...getCodeProps(props) }));
  const language = /language-(\w+)/.exec(codeProps.className || "")?.[1] ?? "";
  if (typeof children !== "string") return (0, import_jsx_runtime5.jsx)(DefaultCodeBlockContent, {
    node,
    components: {
      Pre: WrappedPre,
      Code: WrappedCode
  ...
  return (0, import_jsx_runtime5.jsx)(DefaultCodeBlock, {
    node,
    components: {
      Pre: WrappedPre,
      Code: WrappedCode,
...
var CodeOverrideImpl = ({ node, components, componentsByLanguage, ...props }) => {
  if (!useIsMarkdownCodeBlock()) return (0, import_jsx_runtime5.jsx)(components.Code, { ...props });
  return (0, import_jsx_runtime5.jsx)(CodeBlockOverride, {
    node,
    components,
...
var CodeOverride = (0, import_react4.memo)(CodeOverrideImpl, (prev, next) => {
...
function productionCreate(_, jsx8, jsxs3) {
  return create2;
  function create2(_2, type, props, key) {
    const isStaticChildren = Array.isArray(props.children);
    const fn = isStaticChildren ? jsxs3 : jsx8;
...
var MarkdownTextInner = ({ components: userComponents, componentsByLanguage, smooth = true, preprocess: preprocess2, ...rest }) => {
  ...
  const { text: text5 } = useSmooth((0, import_react7.useMemo)(() => {
    if (!preprocess2) return messagePartText;
    return {
      ...messagePartText,
      text: preprocess2(messagePartText.text)
    };
  }, [messagePartText, preprocess2]), smooth);
  ...
  const CodeComponent = useCallbackRef((props) => (0, import_jsx_runtime7.jsx)(CodeOverride, {
    components: useCodeOverrideComponents,
    componentsByLanguage,
    ...props
  }));
  return (0, import_jsx_runtime7.jsx)(Markdown, {
    components: (0, import_react7.useMemo)(() => {
...
var MarkdownTextPrimitiveImpl = (0, import_react7.forwardRef)(({ className, containerProps, containerComponent: Container = "div", ...rest }, forwardedRef) => {
  return (0, import_jsx_runtime7.jsx)(Container, {
    ...
    ref: forwardedRef,
    children: (0, import_jsx_runtime7.jsx)(MarkdownTextInner, { ...rest })
  });
});
