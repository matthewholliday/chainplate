...
class AgentEnvironment:
    ...
    def __init__(self, execution_id: Optional[int] = None, data_service: Optional[DataService] = None):
        ...
        self.execution_id = execution_id if execution_id is not None else self.data_service.create_execution("agent")
